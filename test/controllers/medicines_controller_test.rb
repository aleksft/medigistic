...
class MedicinesControllerTest < ActionController::TestCase
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post :create, medicine: { description: @medicine.description, expiration: @medicine.expiration, name: @medicine.name, user_id: @medicine.user_id }
    end
  ...
  test "should update medicine" do
    patch :update, id: @medicine, medicine: { description: @medicine.description, expiration: @medicine.expiration, name: @medicine.name, user_id: @medicine.user_id }
    assert_redirected_to medicine_path(assigns(:medicine))
  end
